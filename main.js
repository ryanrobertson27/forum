...
//   newPostMessagePara.classList.add('my-0', 'col-11')
...
//   newAuthorDiv.classList.add('row', 'my-3', 'pt-3', 'border-top', 'align-items-center')
...
//   postedTime.classList.add('col', 'text-black-50', 'text-opacity-50');
